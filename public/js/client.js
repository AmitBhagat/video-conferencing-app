...
function showAbout() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: '<strong>A Video Conferencing Application</strong>',
        imageAlt: 'mirotalk-about',
        imageUrl: aboutImg,
        html: `
        <br/>
        <div id="about">
            Author:<a href="https://www.linkedin.com/in/miroslav-pejic-976a07101/" target="_blank"> Payal Godbole & Nikita Patil</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
